...
import { wrapper } from '../utils/proxy-unproxy-objects.js';
import { precompileTemplate } from '@ember/template-compilation';

var TEMPLATE = precompileTemplate("{{#if @enableClicking}}\n  <a href=\"#\" {{fn this.selectForDrag}}>\n    {{yield}}\n  </a>\n{{else}}\n  {{yield}}\n{{/if}}");
...
var draggableObject = setComponentTemplate(TEMPLATE, Component.extend({
